...
format:
 ...
 pdf:
  ...
  header-includes:
   ...
   # ── figuras más pequeñas por default y ancladas en flujo ──
   - \usepackage{graphicx}
...
| **Julia** | Métricas de fragmentación, topología DE-9IM, cómputo geométrico | `GeoJSON.jl`, `DataFrames.jl`, `LibGEOS.jl`, `Statistics` | `src/julia/04_fragmentacion.jl`, `notebooks/04c_topología_julia`, `14_validacion_trilingual` |
...
El listado de los diez eventos GFD con mayor área inundada sobre el AOI (Inicio, Fin, Área en km² y Días de duración) se reporta en el Anexo F.8 del documento complementario.
