...
format:
  ...
  pdf:
    ...
    header-includes:
      ...
      - \AtBeginEnvironment{longtblr}{\footnotesize}
...
2. Identificar los periodos de degradación y recuperación del manglar entre 2013 y 2025 mediante análisis de anomalías temporales.
...
El conjunto de datos satelitales del proyecto se apoya principalmente en las misiones Landsat 8 y Landsat 9 (NASA-USGS), el modelo digital de elevación SRTM v3 (NASA) y los índices climáticos ENSO ONI y SOI del Climate Prediction Center de la NOAA, complementados con la Global Flood Database del Dartmouth Flood Observatory ---derivada de MODIS NASA y Sentinel-1 ESA--- para el inventario histórico de inundaciones. La capa óptica de alta resolución espacial y temporal proviene de la constelación europea Sentinel-2 (ESA-Copernicus), y la observación radar de Sentinel-1 (ESA-Copernicus). La segmentación promptable del manglar se ejecuta con la biblioteca SamGeo (Wu y Osco, 2023), adaptación geoespacial del *Segment Anything Model* de Meta AI. Los registros hidrométricos del río Magdalena en la estación El Banco y del río Aracataca en Ganadería Caribe provienen del IDEAM, mientras que la cartografía de referencia para la validación es la cobertura oficial colombiana de manglares 1:25.000 publicada por INVEMAR (2020) y la cartografía global ESA WorldCover v200 (Zanaga et al., 2022).
...
: Correlación de Pearson entre anomalía de caudal IDEAM y NDVI z-score, desagregada por estación hidrológica, naturaleza espectral del sitio de monitoreo y rezago temporal. {#tbl-caudal-corr tbl-colwidths="[34, 22, 16, 18, 10]"}
...
: Correlación de Pearson entre anomalía mensual de precipitación CHIRPS sobre cuencas aportantes y NDVI z-score de las estaciones de la CGSM, principales valores por cuenca, naturaleza y rezago temporal. {#tbl-chirps-corr tbl-colwidths="[28, 22, 18, 22, 10]"}
