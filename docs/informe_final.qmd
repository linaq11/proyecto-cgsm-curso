...
| Periodo | Parches | Area total (ha) | Area media (ha) |
|---------|---------|-----------------|-----------------|
| Degradacion (2020-S2) | 100 | 8.829,1 | 88,3 |
| Recuperacion (2022-S1) | 67 | 13.088,2 | 195,4 |
| Actual (2024--2025) | 104 | 17.075,8 | 164,2 |

: Areas de manglar recalculadas sobre EPSG:9377 (MAGNA-SIRGAS Origen Nacional). {#tbl-areas-9377}
...
|---------|---------|------------------|------------|--------------------|
| Degradacion | 100 | 24 | 24,0 | 2.238,1 |
| Recuperacion | 67 | 5 | 7,5 | 1.640,0 |
| Actual | 104 | 19 | 18,3 | 2.076,2 |

: Parches de manglar truncados por la frontera del AOI (predicado DE-9IM `intersects`). {#tbl-topologia}
