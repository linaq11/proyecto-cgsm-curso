...
El repositorio público está disponible en https://github.com/linaq11/proyecto-cgsm-curso bajo licencia MIT. La versión anterior del proyecto (línea base marzo 2026 sobre AOI preliminar de 5.073 km²) permanece archivada en https://github.com/LinaQuinteroF/proyecto-cgsm para fines de comparación histórica.

    proyecto-cgsm-curso/
    ├── notebooks/        30 notebooks: 23 serie principal + 7 legacy (trazabilidad)
    │                     orden de ejecución: 01 → 02 → 02b → 03_acotado →
    │                     04_acotado → 04b_acotado → 05_acotado → 06b → 07 → 08 →
