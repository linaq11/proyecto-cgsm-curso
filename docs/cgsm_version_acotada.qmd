...
| Forzamiento | Rezago óptimo (meses) | $\rho$ vs NDVI manglar |
|----------|----------------------|------------------------|
...
: Correlación de Pearson entre cada forzamiento climático-hidrológico y la anomalía NDVI z-score sobre las cuatro estaciones de manglar denso. {#tbl-clima-resumen tbl-colwidths="[42, 22, 36]"}
